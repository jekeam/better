...
bet = 0  # round(0.10 * (bal1 + bal2))  # Общая масксимальная сумма ставки
...
if __name__ == '__main__':
    ...
    while True:
        ...
        shutdown_minutes = 60 * (60 * 3)  # секунды * на кол-во (60*1) - это час
