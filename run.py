...
if __name__ == '__main__':
    ...
    prnts('olimp_seeker_matchs - start')
    time.sleep(time_sleep_proc)
    ...
    prnts('olimp_seeker_pre_matchs - start')
    time.sleep(time_sleep_proc)
    # time.sleep(60)
    ...
    prnts('fonbet_seeker_matchs - start')
    time.sleep(time_sleep_proc)
    ...
    prnts('fonbet_seeker_pre_matchs - start')
    time.sleep(time_sleep_proc)
    # while True:
