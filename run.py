...
def get_forks(forks, forks_meta, pair_mathes, bets_olimp, bets_fonbet, arr_top_matchs, arr_values):
    global opposition
                    ...
                    for kof_type_olimp, kof_type_fonbet in opposition_pair.items():
                        ...
                        try:
                            if type_time == 'pre':
                                # ОП=В*(К-1)*С-(1-В)*С
                                value_arr = [
                                    [v_olimp, v_fonbet2, 'Валуйная ставка в Олимп на {}\nсобытие: ' + kof_type_olimp + '({})\nзавышен на: {}\nожидаемая прибыль: {}%'],
                                    [v_fonbet, v_olimp2, 'Валуйная ставка в Фонбет на {}\nсобытие:' + kof_type_fonbet + '({})\nзавышен на: {}\nожидаемая прибыль: {}%'], 
                                    [v_fonbet2, v_olimp, 'Валуйная ставка в Фонбет на {}\nсобытие:' + kof_type_olimp + '({})\nзавышен на: {}\nожидаемая прибыль: {}%'], 
                                    [v_olimp2, v_fonbet, 'Валуйная ставка в Олимп на {}\nсобытие:' + kof_type_fonbet + '({})\nзавышен на: {}\nожидаемая прибыль: {}%']
                                ]
...
if __name__ == '__main__':
    try:
        ...
        arr_values = []
        starter_forks = threading.Thread(target=get_forks, args=(forks, forks_meta, pair_mathes, bets_olimp, bets_fonbet, arr_top_matchs, arr_values))
        starter_forks.start()
        prnts(' ')
